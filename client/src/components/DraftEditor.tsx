...
const DraftEditor: React.FC<DraftEditorProps> = ({ onSaveDraft, editMode = false }) => {
  ...
  return (
    <div className="min-h-[38rem] bg-gray-900 text-gray-200 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Draft - 1" className="block w-full rounded-md border border-blue-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm px-2 py-2 resize-none" />
        </div>
        ...
        <div className="space-y-6">
          {currentDraft &&
            currentDraft.pages.map((page,index) => (
              <div key={index} className="p-6 rounded-lg shadow-md dark:bg-gray-800 dark:text-white bg-gray-100 text-gray-900">
