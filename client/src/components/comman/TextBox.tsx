...
const TextBox: React.FC<InputProps> = ({ id, error, register, label, type = "text", placeholder, isTextArea = false }) => {
  ...
  const classes = "block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm px-2 py-2 resize-none";
  return (
    <div className="mb-4">
